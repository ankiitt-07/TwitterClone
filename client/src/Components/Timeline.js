...
//       try {
//         const response = await axios.get('/api/posts'); // Adjust the URL to match your backend API endpoint
...
const Timeline = () => {
   ...
   console.log(posts);
    useEffect(() => {
      ...
      const fetchPosts = async () => {
        try {
          const response = await axios.get('http://localhost:3001/tweets'); // Adjust the URL to match your backend API endpoint
        //   setPosts(response.data); // Assuming the response contains an array of posts
        console.log(response.data.tweets);
        let newArr = response.data.tweets;
        setPosts(newArr);
        // console.log(posts)
        } catch (error) {
          console.error('Error fetching posts:', error);
    ...
    return (
        ...
        <div>
            ...
            <aside class="left-side">
                ...
                <div class="profile-btn">
                    <div class="left-column">
                        <img class="profile-image" alt="hello" src="https://pbs.twimg.com/profile_images/1412572443928109062/t83VHF1j_400x400.jpg"/>
                    </div>
                    <div class="right-column">
                    <div>
                        <strong>
                            <span>{user.name}</span>
                            <svg viewBox="0 0 24 24" aria-label="Korumalı hesap">
                                <g>
            ...
            <section class="content">
                ...
                <div class="tweet">
                    <div class="left-column">
                        <img class="profile-image" alt='helloo' src="https://pbs.twimg.com/profile_images/1412572443928109062/t83VHF1j_400x400.jpg"/>
                    </div>
                    <div class="right-column">
                        <form class="top-row">
                           ...
                           <ul>
                                <li>
                                   { posts.map(postObj => (
                                            <div class="post">
                                            <div class="left-column">
                                                <img class="profile-image" alt='cuis' src="https://pbs.twimg.com/profile_images/1412572443928109062/t83VHF1j_400x400.jpg"/>
                                            </div>
                                            <div class="right-column">
                                                ...
                                                <div>
                                                    <strong>
                                                        <span>{postObj.user.username}</span>
                                                    </strong>
                                                        <span class="tag">@{postObj.user.username}</span>
                                                        <span class="dot">.</span>
                                                ...
                                                <br/>
                                                {postObj.caption}
                                                        {/* <p>My Github Link:<a style={{color:"rgb(27, 149, 224)}"} href={"https://github.com/aygunbaransel"} target="_blank">https://github.com/aygunbaransel</a></p>
                                                        <img src="https://repository-images.githubusercontent.com/124369770/d12e6800-b47a-11e9-85a3-5fe53e198d49" alt="github-logo" style={{width:"100%", border-radius:"25px"; border:1px solid var(--border-color); margin-top:10px;"}}/> */}
                                                </article>
                                                <div class="bottom-row">
                                                    {/* <!-- Comment Button --> */}
                                                    <div>
            ...
            <aside class="right-side">
                ...
                <div class="trends">
                    <header class="trends-header">
                        <h2>
                            {/* <span>İlgini çekebilecek <br>gündemler</br></span> */}
                            <div>
                                <svg viewBox="0 0 24 24" aria-hidden="true">
                                    <g>
                    ...
                    <div class="trends-items">
                        ...
                        <div class="trends-item">
                            ...
                            <strong class="hashtag">#SekeSekeGideceksiniz</strong>
                    ...
                    {/* <!-- Trends Item Start --> */}
                        <div class="trends-item">
                            ...
                            <strong class="hashtag">#Akbank</strong>
                    ...
                    <!-- Trends Item Start --> */}
                        <div class="trends-item">
                            ...
                            <strong class="hashtag">#TSKAnayasalSuçİşliyor</strong>
                    ...
                    {/* <!-- Trends Item Start --> */}
                        <div class="trends-item">
                            ...
                            <strong class="hashtag">#adanaşehirhastanesi</strong>
                    ...
                    <!-- Trends Item Start --> */}
                        <div class="trends-item">
                            ...
                            <strong class="hashtag">#15TemmuzKahramanınaDarbe</strong>
                ...
                <!-- User Item Start --> */}
                    <div class="user">
                        <img class="profile-image" src="https://pbs.twimg.com/profile_images/1164155035930042368/6Xz8S4pg_400x400.jpg"/>
                        <div>
                        <div>
                            <strong class="user-name">Yiğit Özaksüt</strong>
                            <span class="tag">@ozaksuty</span>
                        </div>
                        <button class="follow-btn">Takip Et</button>
                    </div>
                    </div>
                ...
                <!-- User Item Start --> */}
                    <div class="user">
                        <img class="profile-image" alt='hello' src="https://pbs.twimg.com/profile_images/958997253892419586/Jb6NPqEa_400x400.jpg"/>
                        <div>
                        <div>
                            <strong class="user-name">Selman Kahya</strong>
                            <span class="tag">@SelmanKahyaX</span>
                        </div>
                        <button class="follow-btn">Takip Et</button>
                    </div>
                    </div>
